...
class RestScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          controller.i18n.translate("rest")!,
          style: TextStyle(
              fontSize: 20,
      ...
      body: Observer(
          builder:(_) {
            return controller.carregandoValores == true
                ...
                : controller.listaRest.isEmpty
                ? NoData(
                svgName: 'info_icon',
                text: controller.i18n.translate("no_add")!)
                : ListView.builder(
                  shrinkWrap: true,
                  itemCount: controller.listaRest.length,
                        ...
                        child: FadeInAnimation(
                          child: Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Modular.to.pushNamed("/lifeStyle/details", arguments: controller.listaRest[index]);
                              },
                              child: Card(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                        image: NetworkImage(
                                            controller.listaRest[index].imagens[0]),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(
                                            '${controller.listaRest[index].lifeStyleNome}',
                                            style: TextStyle(
                                                fontSize: 20,
                                                color: Colors.white,
