...
class CafeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          controller.i18n.translate("cafes")!,
          style: TextStyle(
              fontSize: 20,
      ...
      body: Observer(
          builder:(_) {
            return controller.carregandoValores == true
                ...
                : controller.listaCafes.isEmpty
                ? NoData(
                svgName: 'info_icon',
                text: controller.i18n.translate("no_add")!)
                : ListView.builder(
                  shrinkWrap: true,
                  itemCount: controller.listaCafes.length,
                        ...
                        child: FadeInAnimation(
                          child: Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Modular.to.pushNamed("/lifeStyle/details", arguments: controller.listaCafes[index]);
                              },
                              child: Card(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                        image: NetworkImage(
                                            controller.listaCafes[index].imagens[0]),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(
                                            '${controller.listaCafes[index].lifeStyleNome}',
                                            style: TextStyle(
                                                fontSize: 20,
                                                color: Colors.white,
